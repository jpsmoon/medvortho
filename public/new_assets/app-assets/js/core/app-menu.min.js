	...
	m.app.menu = {
		...
		change: function(e) {
			...
			if (n) switch (n.name) {
				...
				// 	break;
                case "lg":
					"vertical-overlay-menu" === i ? this.hide() : "vertical-compact-menu" === i ? this.open() : "horizontal-menu" === i && "lg" == n.name 
					? this.collapse() : "collapsed" === e ? this.collapse(e) :this.collapse();
					break;
				case "md":
		...
		open: function() {
			u.is(".vertical-mmenu") && this.mMenu.enable(), this.transit(function() {
				u.removeClass("menu-hide menu-collapsed").addClass("menu-open"), this.hidden = !1, this.collapsed = !1
			}, function() {
		...
		hide: function() {
			u.is(".vertical-mmenu") && this.mMenu.disable(), this.transit(function() {
				u.removeClass("menu-collapsed").addClass("menu-expanded"), this.hidden = !0, this.expanded = !1
			}, function() {
