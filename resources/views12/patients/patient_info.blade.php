...
<div class="form-row col-12 mt-4">
    ...
    <div class="form-group col-md-4">
        ...
        <input value="{{($patient && $patient->zipcode) ? $patient->zipcode : NULL }}" onFocus="this.selectionStart = this.selectionEnd = this.value.length;"  type="text" id="zipcode" name="zipcode" class="form-control" onKeyUp="getStatesByZipCode(this.value);"
            data-validation-event="change" autocomplete="off" data-validation="number length" data-mask="99999?9" data-validation-error-msg="Please Enter the 5 Digit Zip code Number" data-validation-length="1-10" data-validation-optional="true"
    ...
    <div class="form-group col-md-4">
        <label for="contact_no"> Landline</label>
        <input value="{{($patient && $patient->landline_no) ? $patient->landline_no : NULL }}" type="text" name="landline_no" data-mask="(999) 999-9999" class="form-control" maxlength="12" data-validation-error-msg="Please Enter the 10 Digit Landline Number">
    </div>
