                    ...
                    <div align="center" width="100%">
                        <img src="https://www.pretentious.me/public/new_assets/app-assets/images/logo.png" width="250px" alt="logo">
                            ...
                            <table class="table-borderless" style="font-family: Arial, Helvetica, sans-serif;">
                              ...
                              <tr style="border-bottom: 2px solid #000;">
                                <td style=" padding-left:5px; font-size:24px; font-weight:400; text-align: left; font-family: Arial, Helvetica, sans-serif">Payment Compliance Dates</td>
                                <td style=" padding-right:5px; font-size:24px; font-weight:400; text-align: right; font-family: Arial, Helvetica, sans-serif">e-Bill Transmission </td>
                             </tr>
