...
#multi-step-form-container ul.form-stepper {
                    ...
                    <ol class="list-inline breadcrumb bg-transparent align-self-center m-0 p-0">
                       <li class="list-inline-item">
                        ...
                        <li class="list-inline-item">
                            ...
                            <a class="btn btn-primary" href="{{ url('/view/patient/injury/bill/') }}/{{$injuryBillInfo->getInjury->id}}">
                                Back</a>
                            @endif
                        </li>
                    </ol>
                                                ...
                                                <div class="card mb-0">
                                                    ...
                                                    <div class="card-body2">
                                                        <div class="table-responsive">
                                                            <table id="billInformation" class="table layout-secondary table-striped">
                                                                <tbody>
                                                                <tr>
                                                                    <th scope="row">DOS</th>
                                                ...
                                                <div class="card mb-1">
                                                    <div class="card-header">
                                                         <div class="row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <h6 class="card-title text-warning showPointer" data-toggle="modal" data-target="#addDCModel"><i class="fa fa-plus-circle"></i> Diagnosis Code</h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-body2">
                                                        <div class="table-responsive">
                                                            <table id="diagnosisCode" class="table layout-secondary table-striped">
                                                                <tbody>
                                                                <tr>
                                                    ...
                                                    <div class="card-body2">
                                                        <div class="table-responsive">
                                                            @if($injuryBillInfo->getInjury && $injuryBillInfo->getInjury->patient)
                                                                <table id="patientDemographics" class="table layout-secondary table-striped">
                                                                    <tbody>
                                                                    <tr>
                                                                        ...
                                                                        {{($injuryBillInfo->getInjury->patient->mi) ? " ".$injuryBillInfo->getInjury->patient->mi : ''}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th scope="row">DOB</th>
                                            ...
                                            <div class="col-sm-12 pr-0">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body2">
                                                        <div class="table-responsive">
                                                        @if($injuryBillInfo && $injuryBillInfo->getInjury)
                                                            <table id="injuryInformation" class="table layout-secondary table-striped">
                                                                <tbody>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">DOI</th>
                                                                    <td>{{($injuryBillInfo->getInjury->getInjuryClaim && $injuryBillInfo->getInjury->getInjuryClaim->start_date) ? date('m/d/Y', strtotime($injuryBillInfo->getInjury->getInjuryClaim->start_date)) : 'NA'}}</td>
                                                                </tr>
                                                                <tr>
                                        ...
                                        <div class="card mb-1">
                                            <div class="card-header">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <h6 class="card-title text-warning showPointer" data-toggle="modal" data-target="#addPCModel"><i class="fa fa-plus-circle"></i>  Procedure Code</h6>
                                                    </div>
                                                </div> 
                                            </div>
                                            <div class="card-body2">
                                                <div class="table-responsive2">
                                                    <table id="procedureCodeDetail" class="table layout-secondary table-striped table-bordered">
                                                        <thead class="thead-dark main-head">
                                                            <tr>
                                                            @if($injuryBillInfo->getStatus && $injuryBillInfo->getStatus->slug_name && $injuryBillInfo->getStatus->slug_name == 'SENT_BILL')
                                                                <td> <label class="mb-0"><input type="checkbox" id="checkAll" /> Select All</label></td>
                                                            @endif
                                                        ...
                                                        <tbody>
                                                            @php $totCharAmt = 0; $totPaymentAmt = 0; $blcDue = 0; $expectedAmt = 0; $calculateBrAmt = 0;
                                                            $originSubAmt = 0; $billPaymentAmt = 0;  $writeOffAmt = 0; $blcDueAmt = 0;
                                                            $expectedFeeSAmt = 0;  $totalUnit = 0;
                                                            @endphp
                                                            ...
                                                            @foreach ($injuryBillInfo->getBillServices as $bill)
                                                                ...
                                                                $calculateBrAmt += $bill->master_unit_amount;
                                                                @endphp
                                                            <tr>
                                                            @if($injuryBillInfo->getStatus && $injuryBillInfo->getStatus->slug_name && $injuryBillInfo->getStatus->slug_name == 'SENT_BILL')
                                                                <td>
                                                                    <label><input class="chk" type="checkbox" name=billCheckId[] value="{{$bill->id}}" onClick="showSecondReviewDiv(this.value, {{$bill->id}});" /> </label>
                                                                </td>
                                                                @endif
                                                            ...
                                                            <tr>
                                                                    <td colspan="12"> 
                                                                      <h3>Bill Second Review<h3> 
                                                                        <table id="procedureCodeSbr" class="table">
                                                                            <thead class="thead-dark">
                                                                                <tr>
                                                                                    <th>Reason Text</th>
                                                                                    <th>Reason Description</th>
                                                                                    <th>Service Good</th>
                                                                                    <th>New Attached Document</th>
                                                                                </tr>
                                                                            </thead>
                                                                            
                                                                            <tbody>
                                                                                <td> {{ ($bill->getBillProcedureSBR->getBillingProviderSecondReview) ?  substr_replace($bill->getBillProcedureSBR->getBillingProviderSecondReview->description, "...", 50) : ''}}</td>
                                                                                <td> {{ ($bill->getBillProcedureSBR->review_text) ? substr_replace($bill->getBillProcedureSBR->review_text, "...", 50) : ''}} </td>
                                                                                <td> {{ ($bill->getBillProcedureSBR->service_good && $bill->getBillProcedureSBR->service_good == 1 ) ? $bill->getBillProcedureSBR->service_good : ''}}</td>
                                                                                <td> {{ ($bill->getBillProcedureSBR->attched_document && $bill->getBillProcedureSBR->attched_document == 1 ) ? $bill->getBillProcedureSBR->attched_document : ''}}</td>
                                                                            </tbody>
                                                                            <tfoot>
                                                                                <tr>
                                                                                    <td colspan="6"><span class="btn btn-primary">Edit</span></td>
                                                                                </tr>
                                                                            </tfoot>
                                                                        </table> 
                                                                    </td>
                                                            ...
                                                            <tr id="showSecondReviewDiv_{{$bill->id}}" class="d-none">
                                                                <input type="hidden" name="secondReviewBillId[]" id="secondReviewBillId_{{$bill->id}}" value>
                                                                <td colspan="12">
                                                                 <div class="card mb-0">
                                                                    <div class="card-body"> 
                                                                        <div class="row">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                                                <label for="resoanForDescription">  </label>
                                                                        ...
                                                                        <div class="row">
                                                                             <div class="col-xs-6 col-sm-6 col-md-6">
                                                                                ...
                                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                                    <input type="radio" class="serviceGood"  name="service_good[]" id="service_good1_{{$bill->id}}" value="1"> Yes 
                                                                                    <input type="radio" class="serviceGood"  name="service_good[]" id="service_good2_{{$bill->id}}" checked value="2"> No 
                                                                                </div>
                                                                            </div> 
                                                                        </div>
                                                                        <div class="row">
                                                                             <div class="col-xs-6 col-sm-6 col-md-6">
                                                                                ...
                                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                                    <input type="radio" class="newDocument" data-toggle="modal" data-target="#showUploadDocumentDiv"
                                                                                      name="new_documen_atttched[]" onClick="showNewDocumentDiv({{$bill->id}})" id="new_documen_atttched1_{{$bill->id}}" value="1"> Yes  
                                                                                    <input type="radio" class="newDocument"  name="new_documen_atttched[]" id="new_documen_atttched2_{{$bill->id}}" checked value="2"> No 
                                                                                </div>
                                                                             </div>
                                                                        </div> 
                                                                    </div>
                                        ...
                                        <div class="card mb-1 mt-1">
                                            ...
                                            <div class="row mt-2">
                                                <!--<div class="col-sm-4">(e-Bill)</div>-->
                                                    @if($isFoundCMS)
                                                        <div class="col-sm-4">
                                                            <a href="{{ asset('/bills/cms/'.$isFoundCMS->temp_document_name) }} " target="_blank">View CMS 1500 PDF</a>
                                                        </div> 
                                                    @endif 
                                                    @if($isFoundCover)
                                                        <div class="col-sm-4"> 
                                                            <a target="_blank" href="{{ asset('/bills/coverSheet/'. $isFoundCover->temp_document_name) }} " >View Submission Coversheet</a>
                                                        </div>
                                                    @endif 
                                            </div>
                                            </div>
                    ...
                    <div id="multi-step-form-container">
                        ...
                        <span class="bill_overdue_days {{$txtColor}}">
                            ...
                            @foreach ($billStatuss as $status)
                                <!-- Step 1 -->
                                <li class="{{ ($injuryBillInfo->bill_stage == $status->id) ? 'form-stepper-active' : 'form-stepper-unfinished'}} text-center form-stepper-list" step="{{$i}}">
                                    <a class="mx-2">
                                        <span class="form-stepper-circle">
                                            <span>{{$i}}</span>
                                        </span>
                                        <div class="label {{ ($injuryBillInfo->bill_stage == $status->id) ? ' ' : 'text-muted'}}">{{strtoupper($status->status_name)}}</div>
                                    </a>
                                </li>  
                                @php $i++; @endphp 
                                @endforeach
                            ...
                            @if($taskAssign)
                            <ul class="form-stepper form-stepper-horizontal text-center mx-auto pl-0">
                                 <li class="form-stepper-active"><h3>{{ str_replace('_', ' ', trim($taskAssign->status_alias))}}</h3></li>
                            </ul>
                                @if($taskAssign->status_alias == 'SEND_BILL')
                                    <div class="row">
                                        <div class="col-12 ">
                                ...
                                @endif
                                 @if($taskAssign->status_alias == 'SENT_BILL')
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="col-4">
                                                <button type="button" class="btn btn-secondary ladda-button" data-toggle="modal" data-target="#addWriteOfLetterrForCloseBillModal" id="billCloseBtn">Close Bill</button>
                                            </div>
                                        </div> 
                                    </div> 
                                @endif
                             @endif
                              @if($injuryBillInfo->getStatus->slug_name == 'CLOSED_BILL')
                                <div class="row">
                                        <div class="col-6">
                                            <div class="col-4">
                                                <button type="button" class="btn btn-secondary ladda-button" id="billOpenBtn">Open Bill</button>
                                            </div>
                                        </div> 
                                    </div> 
                              @endif
                            ...
                            <div class="tab-pane fade pr-0 pl-0" id="nav-stats" role="tabpanel" aria-labelledby="nav-stats-tab" style="background:#fff; margin:0 0;">
                                <div class="table-responsive">
                            ...
                            <div class="tab-pane fade  pr-0 pl-0" id="nav-letters" role="tabpanel" aria-labelledby="nav-stats-tab" style="background:#fff; margin:0 0;">
                                <div class="table-responsive">
                                    <table id="billsLogs" class="table layout-secondary dataTable table-striped table-bordered">
                                        <thead class="thead-dark">
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="text-dark" href="{{ url('/bill-submissions/letters/authorization-letter', $injuryBillInfo->id) }}">View</a></td>
                                            </tr>
                        ...
                        <div class="modal-body">
                            <div class="form-row cloneDCDiv">
                                <div class="form-group col-md-6 cloneDivDiagnosisCode" id="dio_Code_1">
                                    ...
                                    <input type="text" name="work_dg_code_id[]" class="work_dg_original" id="work_dg_code_id_1"> 
                    ...
                    <div class="modal-content ">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <input type="radio" class="sendType" onclick="showFaxOptionDiv(this.value);" name = "delivery_Method" value="1" checked data-validation-event="change" data-validation="required" data-validation-error-msg=""> Send e-bill </br>
                                        <input type="radio" class="sendType" onclick="showFaxOptionDiv(this.value);" name = "delivery_Method" value="2" data-validation-event="change" data-validation="required" data-validation-error-msg=""> Send via fax </br>
                                        <input type="radio" class="sendType" onclick="showFaxOptionDiv(this.value);" name = "delivery_Method" value="3" data-validation-event="change" data-validation="required" data-validation-error-msg=""> Download Packet</br>
                                    </div>
                                </div> 
                            </div> 
                            ...
                            <div class="row d-none" id="downloadPDFDiv">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <select onchange="checkAction();" id="claimAdminDownloadPdf"  name="claimAdminDownloadPdf"  class="form-control">
                                        <option value="">Please Select</option>
                                        <option value="{{($injuryBillInfo->getInjury && $injuryBillInfo->getInjury->getInjuryClaim && $injuryBillInfo->getInjury && $injuryBillInfo->getInjury->getInjuryClaim->claim_admin_id) ? $injuryBillInfo->getInjury->getInjuryClaim->claim_admin_id : null }}">
                                        {{($injuryBillInfo->getInjury  && $injuryBillInfo->getInjury->getInjuryClaim  && $injuryBillInfo->getInjury->getInjuryClaim->getClaimAdmin && $injuryBillInfo->getInjury->getInjuryClaim->getClaimAdmin->admin_address) ? $injuryBillInfo->getInjury->getInjuryClaim->getClaimAdmin->admin_address : ''}}</option>
                                    </select>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            <button type="button" id="sendBtnId" onClick="submitPacketPdf();"; disabled  class="btn btn-primary">Send</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <!-- Modal content -->
    <!-- Modal content -->
        <div class="modal fade" id="showUploadDocumentDiv" tabindex="-1" role="dialog" aria-labelledby="showUploadDocumentLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <input type="hidden" name="bill_procesure_code_id" id="bill_procesure_code_id" value=""> 
                <form id="billProcedureDocumentFrm" enctype="multipart/formdata">
                    <div class="modal-content ">
                                        ...
                                        <div class="img-drop">
                                            ...
                                            <span class="btn btn-success btn-file">
                                                Click to Open File Browser<input
                                                    type="file" name="billDocFile" id="billDocFile" accept="application/pdf/*">
                                            </span>
                                        </div>
                                    </div> 
                                </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            <button type="button" onClick="saveProcedureDocument();" data-dismiss="modal"  class="btn btn-primary">Save</button>
                        </div>
                    </div>
                </form>
            </div>
                        ...
                        <div class="modal-body">
                             <div class="row cloneDiv bg-light p-2 pt-0" id="input_1">
                                <div class=" col-md-2">
                                        ...
                                        <input onkeyup='searchAutoForProcedureCode(event);' placeholder="Procedure Code"  data-validation-event="change" data-validation="custom" data-validation-regexp ="^[a-zA-Z0-9]+(\s+[a-zA-Z0-9]+)*$" data-validation-optional="true" data-validation-error-msg="" 
                                        id="bill_procedure_code_{{$i}}" autocomplete="off" type="text" name="bill_procedure_code[]" value=""
                                        class="form-control procedure_code_input" maxlength="100">
                                        <ul id="search_bill_procedure_code_{{$i}}" class="autoCompete-css procedure_code_ul"></ul>
                                        @if($errors->has('bill_procedure_code'))
                                        <span class="invalid-feedback" style="display:block" role="alert">
                                            <strong class="invalid-feedback" >{{ $errors->first('bill_procedure_code') }}</strong>
                                        </span>
                                        @endif 
                                        <div class=" col-md-1  cus-plus d-none" id="addition_info_icon_{{$i}}" style="max-width: 2%;">
                                ...
                                <div class=" col-md-3">
                                    ...
                                    <select name="bill_modifiers[]"  multiple onChange='setUnitCodeOnChangeProcedureCode(event, 1)'   class=" select2-original modefierCode"   id="bill_modifiers{{$i}}" >
                                        <option value="">-Select-</option>
                                ...
                                <div class=" col-md-1">
                                    ...
                                    <input placeholder="Units" data-validation-event="change" data-validation="custom" data-validation-regexp ="^[0-9]+(\s+[0-9]+)*$" data-validation-optional="true" data-validation-error-msg="" autocomplete="off" id="bill_units{{$i}}" type="text" name="bill_units[]" value="1" class="form-control bill_unit" maxlength="5">
                                ...
                                <div class=" col-md-6" id="childPt">
                                    ...
                                    <table>
                                        <tr>
                                            <td><input placeholder="Diag Code 1" autocomplete="off" type="text" id="billDiagCodes1_{{$i}}" name="bill_diag_codes1[]" value="" class="form-control bill_diag_codes1" maxlength="50"></td>
                                            <td><input placeholder="Diag Code 2" autocomplete="off" type="text" id="billDiagCodes2_{{$i}}" name="bill_diag_codes2[]" value="" class="form-control bill_diag_codes2" maxlength="50"></td>
                                            <td><input placeholder="Diag Code 3" autocomplete="off" type="text" id="billDiagCodes3_{{$i}}" name="bill_diag_codes3[]" value="" class="form-control bill_diag_codes3" maxlength="50"></td>
                                            <td><input placeholder="Diag Code 4" autocomplete="off" type="text" id="billDiagCodes4_{{$i}}" name="bill_diag_codes4[]" value="" class="form-control bill_diag_codes4" maxlength="50"></td>
                                            <td class='removeBtn' id="remove_item_icon_{{$i}}"><a  href='javascript:void(0);'><i class='icon-trash'></i></a></td>
                                        </tr>
                                        <tr>
                                            <td colspan="6" class="error_msg" id="showDiagCodeError_{{$i}}">
                                            </td>
                                        </tr>
                                    </table>
                                </div> 
                                <div class="col-md-2 pt-1 pl-0 d-none" id="addition_info_div_{{$i}}">
    ...
    <!-- Modal content -->
     <!-- Modal content -->
        <div class="modal fade" id="addWriteOfLetterrForCloseBillModal" role="dialog" aria-labelledby="addWriteOfLetterrForCloseBillModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document"> 
                <form   method="POST" action="{{ route('addbillWriteOfReasonForCloseBill') }}" id="addbillWriteOfReasonForCloseBillId">
                    @csrf
                    <input type="hidden" name="billId" class="" id="billId_1" value="{{$injuryBillInfo->id}}">
                    <input type="text" name="taskId" class="" id="taskIdDiv" value="{{ ($taskAssign) ? $taskAssign->id : ''}}">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addWriteOfLetterrForCloseBillModalLabel">Add Reason For Bill Close</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                             <div class="row"> 
                                <div class=" col-md-9">
                                    <label for="writeOfReason">Library Bill Write Off Reason<span class="required">* </span></label>
                                    <select name="bill_provider_write_of_reason" class="form-control" data-validation-event="change" data-validation="required"
            data-validation-error-msg="">
                                        <option value="">-Select-</option>
                                        @foreach ($providerReasonForCloseBill as $writeReason)
                                            <option value="{{$writeReason->id}}">{{($writeReason->reason_text) ? substr($writeReason->reason_text, 0, 80) : ''}}</option>
                                        @endforeach
                                    </select>
                                    @if($errors->has('bill_provider_write_of_reason'))
                                    <span class="invalid-feedback" style="display:block" role="alert">
                                        <strong class="invalid-feedback" >{{ $errors->first('bill_provider_write_of_reason') }}</strong>
                                    </span>
                                    @endif
                                </div>
                            </div>
                            <div class="row"> 
                                <div class=" col-md-9">
                                    <label for="write_of_reason_description">Description <span class="required">* </span></label>
            ...
            data-validation-error-msg=""  class="form-control" rows="10" name="write_of_reason_description"> </textarea>
                                    @if ($errors->has('description2'))
                                        <span class="invalid-feedback" style="display:block" role="alert"><strong class="invalid-feedback">{{ $errors->first('write_of_reason_description') }}</strong> </span>
                                    @endif
                                </div>
                            </div>
                        </div>
    ...
    if ($('.chk:checked').length == $('.chk').length) {
        ...
        $.each(searchIDS, function (key, val) {
             $("#showSecondReviewDiv_" + lastEl).each(function() { 
                ...
                billSbrArray.push({ 'billId' : <?php echo $injuryBillInfo->id;?>,'procesureCodeId' : (val) ? parseInt(val) : null, 'billReviewText': billReviewText, 'billReviewDescr': billReviewDescr, 'serviceGood':serviceGood, 'newDocumenAtttched': newDocumenAtttched});
            })  
        }) 
    }
    else{
        $('tr[id^="showSecondReviewDiv_"]').each(function() {
            ...
            var serviceGood = $(this).find('input[name="service_good[]"]:checked').val();
            var newDocumenAtttched = $(this).find('input[name="new_documen_atttched[]"]:checked').val(); 
            billSbrArray.push({ 'billId' : <?php echo $injuryBillInfo->id;?>,'procesureCodeId' : (billId) ? parseInt(billId) : null, 'billReviewText': billReviewText, 'billReviewDescr': billReviewDescr, 'serviceGood':serviceGood, 'newDocumenAtttched': newDocumenAtttched});
        })
    } 
    ...
    if(billSbrArray && billSbrArray.length > 0){
        $.ajax({
            url: '/storeBillSbr',
                type: 'POST',
                data: {
                _token: token, billSbrArray:billSbrArray,
...
function showAllBillDocuments(){
    $.ajax({
        ...
        type: "POST",
        data: {billId : {{$injuryBillInfo->id}}, _token : token},
        beforeSend: function(){
...
function checkAction(){
    ...
    $.ajax({
        ...
        success: function (pdfUrl) {
            ...
            $("#showPdfUrl").removeClass('d-none').attr("href", pdfUrl).append(pdfUrl).addClass('showPointer');
...
function submitPacketPdf(){ 
    ...
    console.log('#pdfFileURL', pdfFileURL);
     $.ajax({
        ...
        success: function (pdfUrl) {
            var $downloadLink = $('<a></a>').attr('href', pdfFileURL).attr('download', new Date().getTime() + ".pdf").css('display', 'none');
