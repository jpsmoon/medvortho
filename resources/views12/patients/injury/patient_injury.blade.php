                                    ...
                                    <div class="row d-none" id="workerCompId">
                                        <div class="col-12">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="employer_name"> Employer Phone Number <span class="required">*
                                                        </span></label>
                                                    <input autocomplete="off" data-validation-event="change" data-validation="required" data-validation-error-msg=""
                                                        type="text" name="employer_phone_number"
                                                        value="{{ ($pInjuries && $pInjuries->getInjuryClaim &&  $pInjuries->getInjuryClaim->employer_phone_number) ? $pInjuries->getInjuryClaim->employer_phone_number : '' }}"
