...
<div class="content-body" >
                                                    ...
                                                    <td width="420px" valign="top">
                                                        <table style="padding-top:0px; font-weight:600">
                                                            @if ($injuryBillInfo->getInjury->patient->getBillingProvider)
                                                                <tr>
                                                                    <td class="pt-10 speCase" style="padding-left:240px; position:relative; top:-15px">
                                                                        @php $phone1 = '';  $phone2 = '';
                                                                ...
                                                                <tr>
                                                                    <td
                                                                        style="padding-top:0px; font-size:14px !important; padding-left:15px;">
 ...
 <div class="buton-part"><button type="button" id="cmdPdfBtn">Print Pdf </button></div>
...
<script type="text/javascript">
    ...
    function getPdfInfo(){
    var pdf = new jsPDF('p', 'px', [600, 800],false);
