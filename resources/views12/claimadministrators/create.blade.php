                                ...
                                <h4 class="px-1 py-0"><i class="fa-solid fa-user"></i> Main</h4>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="alias" class="form-control"  maxlength="25" value="{{($claimadministrator) ? $claimadministrator->alias : null}}">
                                        </div> 
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="claimEmail" class="form-control"  maxlength="55" value="{{($claimadministrator) ? $claimadministrator->email : null}}">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            <label for="" style="float:left;"> Start Time    </label>
                                            <input type="time" name="start_time" class="form-control"  maxlength="10" value="{{ ($claimadministrator) ? $claimadministrator->start_time : null}}">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="" style="float:left;"> End Time    </label>
                                            <input type="time" name="end_time" class="form-control"  maxlength="10" value="{{ ($claimadministrator) ? $claimadministrator->end_time : null}}">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-holder col-md-4">
                                        ...
                                        <div class="form-holder col-md-4">
                                            ...
                                            <textarea name="bill_process_flow_note" class="form-control" style="resize: none;">{{ ($claimadministrator) ? $claimadministrator->bill_process_flow_note : null}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-holder col-md-4">
                                            <label for="" style="float:left;"> Fax Number  <span class="required">* </span>  </label>
                                            <input type="text" name="admin_fax_no" class="form-control"  maxlength="55" value="{{($claimadministrator) ? $claimadministrator->admin_fax_no : null}}">
                                        </div>
                                        <div class="form-holder col-md-4">
                                            <label for="" style="float:left;"> Address     </label>
                                            <textarea name="admin_address" class="form-control" style="resize: none;">{{ ($claimadministrator) ? $claimadministrator->admin_address : null}}</textarea>
                                        </div>
                                    </div>
                            </fieldset> 
                            <fieldset class="mt-2">
                                                ...
                                                @foreach ($claim_mails as $claim_mail)
                                                    <tr id="mail{{$k}}">
                                                        <td>
                                                            ...
                                                            <input type="text" name="company_name[]" value="{{$claim_mail->company_name}}" class="form-control"  maxlength="25">
                                                        </td>
                                                        <td>
...
@endsection
<script src="{{ asset('public/js/controller/claimadministrators.js') }}"></script>
<script>
