...
<!-- END: Breadcrumbs-->
                        ...
                        <div class="sub-header mt-3 py-3 px-1 align-self-center d-sm-flex w-100 rounded heading-background">
                            <div class="w-sm-100 mr-auto">
                                <li class="btn btn-primary" style="padding-bottom:10px" class="breadcrumb-item" data-toggle="modal" data-target="#exampleModalBill">
                                     <b>Add Box 19 Reasons</b>
                                </li>
                            </div>
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0 bold" style="font-size: 25px; padding-top: 5px; font-family: initial;">Box 19 Reasons</h4></div>
                            <div>
    ...
    <div class="modal fade" id="exampleModalBill" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
             <div class="modal-dialog" role="document">
                ...
                <form action="{{ route('saveBox19ReasonReason') }}" method="POST" enctype="multipart/form-data">
                   @csrf
                        <div class="modal-header">
                            <h5 align="center" class="modal-title bold" id="exampleModalLabel">Add Box 19 Reasons</h5>
