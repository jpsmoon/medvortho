                    ...
                    <div class="col-12  align-self-center">
                        <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded heading-background">
                            <div style="padding-top:10px" class="w-sm-100 mr-auto">
                                <h2 class="heading"> Practice Contact Info <svg xmlns="http://www.w3.org/2000/svg"
                                        width="25" height="19" viewBox="0 0 25 19">
                            ...
                            <li class="breadcrumb-item">
                                    <a class="btn btn-primary" href="{{url('/edit/practice/contact')}}/{{$bPracticeContact->billing_provider_id}}/{{$bPracticeContact->id}}"> Edit</a>
                                </li>
                                <li class="breadcrumb-item">
                                    <a class="btn btn-primary"
                                        href="list/practice/contact/{{ $bPracticeContact->bPracticeContact }}"> Back</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="form-row mt-3">
                        <div class="col-md-3">
                            ...
                            <span> {{ $bPracticeContact->suffix_name }}
                                {{ $bPracticeContact->first_name }}
                                {{ $bPracticeContact->middle_name }}
                                {{ $bPracticeContact->last_name }} </span>
                        </div>
                    </div> 
                    <hr>
                    <div class="form-row mt-3">
                        <div class="col-md-3">
                            ...
                            <span> {{ $bPracticeContact->telephone }} </span>
                        </div>
                    </div>
                    <hr>
                    <div class="form-row mt-3">
                        <div class="col-md-3">
                            ...
                            <span> {{ $bPracticeContact->email }} </span>
                        </div>
                    </div>
                    <hr>
                    <div class="form-row mt-3">
