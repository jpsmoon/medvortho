                    ...
                    <div class="col-12  align-self-center">
                        <div class="sub-header mt-3 py-3 px-1 align-self-center d-sm-flex w-100 rounded heading-background">
                            <div style="padding-top:10px" class="w-sm-100 mr-auto">
                                <h2 class="heading pl-1">{{$billingP->professional_provider_name}}</h2> 
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 mt-4 ml-4 pl-4">
                                <div class="row step">
                                    <div id="div1" style="background-color:#f3f3f3;" class="col-md-3 activestep"
                                        onclick="javascript: resetActive(event, 0, '1');">

                                        <p class="bold pointer" style="padding-top:20px; font-size:18px">Billing Settings -
                                            Required</p>
                                    </div>
                                    <div id="div2" style="background-color:#f3f3f3;" class="col-md-3 otherStep"
                                        onclick="javascript: resetActive(event, 20, '2');">

                                        <p class="bold pointer" style="padding-top:20px; font-size:18px">Billing Settings -
                                            Custom</p>
                                    </div>
                                    <div id="div3" style="background-color:#f3f3f3;" class="col-md-3 otherStep"
                                        onclick="javascript: resetActive(event, 40, '3');">

                                        <p class="bold pointer" style="padding-top:20px; font-size:18px">RFA Settings</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 mt-4 ml-4 pl-4 step hiddenStepInfo" id="step-2">
                                ...
                                <div class="row">
                                    ...
                                    <div id="div2" class="col-md-2 otherStep">
                                        <a class="text-dark" href="{{ url('/provider-bill-write-off-reason/'.$id.'/1') }}">
                                            <span class="fa fa-file-text-o"></span>
                                    ...
                                    <div id="div3" class="col-md-2 otherStep">
                                        <span class="fa fa-file-text-o"></span>
                                        <a class="text-dark" href="{{ url('/provider-bill-write-off-reason/'.$id.'/2') }}">
                                    ...
                                    <div id="div3" class="col-md-2 otherStep">
                                        <span class="fa fa-file-text-o"></span>
                                        <a class="text-dark" href="{{ url('/provider-bill-write-off-reason/'.$id.'/3') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div id="div3" class="col-md-2 otherStep">
                                        <span class="fa fa-usd"></span>
                                        <a class="text-dark" href="{{ url('/settings/providers/expected/reimbursements/'.$id.'/2') }}">
                            ...
                            <div class="col-12 mt-4 ml-4 pl-4 step hiddenStepInfo" id="step-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-11"> </div>
                                    <div id="div1" class="col-md-2"
                                        onclick="javascript: resetActive(event, 0, '1');"><br>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px"
                                            viewBox="0 0 34 34">
                                            <title>icon_task</title>
                                            <path
