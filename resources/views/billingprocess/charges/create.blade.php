                        ...
                        <form action="{{ route('saveBillProviderCharge') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <input value="{{($chargeVal) ? $chargeVal->dmepos : 200}}" type="text"  data-validation="number length"  data-validation-length="1-10" style="width:100px; padding-left:8px" id="dmepos" name="dmepos"><span class="inputfill">%</span>
                                    </div>  
                                    </div>
                                    <div class="form-row col-md-12 border-bottom2" style="padding-bottom:15px; padding-top: 10;">
                                    <div class="form-row col-md-6">
                                    <label style="width:200px" for="fname">Pathology : </label>
                                    <input type="text" value="{{($chargeVal) ? $chargeVal->pathology_charge : 200}}"  data-validation="number length"  data-validation-length="1-10" style="width:100px; padding-left:8px" id="pathology" name="pathology"><span class="inputfill">%</span>
                                    </div>
                                    <div class="form-row col-md-6">
                                    <label style="width:200px" for="dispensed_pharmaceuticals">Dispensed Pharmaceuticals : </label>
                                    <input type="text" value="{{($chargeVal) ? $chargeVal->dispensed_pharmaceuticals : 200}}" data-validation="number length" data-validation-length="1-10"  style="width:100px; padding-left:8px" id="dispensed_pharmaceuticals" name="dispensed_pharmaceuticals"><span class="inputfill">%</span>
                                    </div>  
                                    </div> 
                                    <div class="form-row col-md-12 border-bottom2" style="padding-bottom:15px; padding-top: 10;">
                                    <div class="form-row col-md-6">
                                    <label style="width:200px" for="med_legal">Med Legal : </label>
                                    <input type="text" value="{{($chargeVal) ? $chargeVal->med_legal : 200}}" data-validation="number length"  data-validation-length="1-10"  style="width:100px; padding-left:8px" id="med_legal" name="med_legal"><span class="inputfill">%</span>
                                    </div>
                                    <div class="form-row col-md-6">
                                ...
                                <div class="col-md-12 ">
                                        <div class="form-row col-md-12">
                                            ...
                                            <div class="form-group col-md-4">
                                                <button {{ ($chargeVal &&  $chargeVal->physician_services == null &&    $chargeVal->pathology == null &&     
                                                $chargeVal->med_legal == null &&   $chargeVal->dmepos == null &&   $chargeVal->dispensed_pharmaceuticals == null  &&  $chargeVal->copy_service == null 
                                                ) ? '' : 'disabled'  }} type="submit" style="min-width: 120px" class="btn btn-primary ladda-button">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @if(count($providerCharges)>0)
                                        ...
                                        <tr>
                                            <td><a href="{{url('/settings/charges',$charges->id)}}">{{($charges->practice_name) ? $charges->practice_name : '-' }}</a></td>
