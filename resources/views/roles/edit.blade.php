    ...
    <div class="row ">
        <div class="col-12  align-self-center">
            <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 mr-auto"><h4 class="mb-0">Edit Role</h4></div>

                <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                    <li class="breadcrumb-item">
                        <a class="btn btn-primary" href="{{ route('roles.index') }}"> Back22</a>
                    </li>
                </ol>
            </div>
        </div>
                        ...
                        @csrf
                            <div class="row">
                                <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="name" value="{{$role->name}}" class="form-control" data-validation-event="change" data-validation="required, length"
                                    ...
                                    <ul class="list-inline">
                                        @foreach($permission as $value)
                                            <li class="list-inline-item liItem col-md-3">
                                                {{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, array('class' => 'name permissioncls')) }} 
