                                        ...
                                        <div class="col-12">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" data-validation-event="change" data-validation="required" data-validation-error-msg="" id="description"  class="form-control" name="description" {{($pInjuries) ? $pInjuries->description : ''}}>
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <select name="p_state_id" class="form-control stateDD" id="stateDD" data-validation-event="change" data-validation="required"
                                                                data-validation-error-msg="">
                                                                    <option value="" class="option">Select</option>
                                                                    @foreach ($states as $state)
                                                                    <option value="{{$state["state_name"]}}"> {{$state["state_name"]}}</option>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <select name="p_city_id" class="form-control cityDD" id="cityDD">
                                                                    <option value="" class="option">Select</option>
                                                                </select>
