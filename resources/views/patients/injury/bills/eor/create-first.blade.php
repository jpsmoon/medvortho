                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            ...
                                            <div class="tab-content" id="nav-tabContent" style="border:0px solid #333">
                                                <div class="tab-pane fade {{ ($tabId == 'first') ? 'show active' : ''}} p-1" id="single-payment" role="tabpanel" aria-labelledby="single-payment-tab">
                                                    ...
                                                    <form  action="{{ url('/save/single/bill/payment') }}"  enctype="multipart/form-data" id=singleBillPaymentFrm" class="form-horizontal ladda-form'" method="POST">
                                                        @csrf
                                                        ...
                                                        <div class="form-row">  
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input value="{{($billPaymentInfo  && $billPaymentInfo->payment_amount) ?  $billPaymentInfo->payment_amount: null }}" type="text"  onkeyup="setProcessLevelStep();" id="bill_payment_amount_id"  data-validation-event="change" data-validation="required, number"  autocomplete="off"  name="bill_payment_amount"  class="form-control" maxlength="10">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input value="{{($billPaymentInfo  && $billPaymentInfo->refence_number) ?  $billPaymentInfo->refence_number: null }}" type="text" onkeyup="setProcessLevelStep();" id="bill_payment_reference_number_id"  data-validation-event="change" data-validation="required"  autocomplete="off" name="bill_payment_reference_number"  class="form-control" maxlength="10">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-3 pt-2">
                                                                ...
                                                                <div class="controls">
                                                                    <label class="radio inline">
                                                                        <input {{($billPaymentInfo  && $billPaymentInfo->payment_deposite) ? 'checked' : null }} type="radio"  onClick="showDepositeDateDiv(this.value, 'showDepositDiv'); setProcessLevelStep();" name="bill_single_payment_deposit" id="bill_single_payment_deposit1" value="1"/>
                                                                        YES
                                                                    </label>
                                                                    <label class="radio inline">
                                                                        <input  {{($billPaymentInfo  && $billPaymentInfo->payment_deposite) ?  'checked' : null }} type="radio"  onClick="showDepositeDateDiv(this.value, 'showDepositDiv'); setProcessLevelStep();" name="bill_single_payment_deposit" id="bill_single_payment_deposit2" value="2"/>
                                                                        NO
                                                                    </label>
                                                                </div> 
                                                            </div>
                                                            <div class="form-group col-md-3 input-icons d-none" id="showDepositDiv">
                                                                ...
                                                                <input value="{{($billPaymentInfo  && $billPaymentInfo->payment_deposit_date) ?  $billPaymentInfo->payment_deposit_date: null }}"  onkeyup="setProcessLevelStep();" autocomplete="off" value=""  type="text" id="bill_paymeny_deposite_date_id"  name="bill_paymeny_deposite_date"  data-validation-event="change" data-validation="date" data-validation-format="mm/dd/yyyy"  data-validation-error-msg="" autocomplete="off" class="form-control" maxlength="100">
                                                                <i class="icon-calendar"></i>
                                                         ...
                                                         <fieldset>
                                                            ...
                                                            <div class="form-row">  
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input value="{{($billPaymentInfo &&   $billPaymentInfo->getBillPaymentMultipleClaimNumberInfo && $billPaymentInfo->getBillPaymentMultipleClaimNumberInfo->payer_claim_control_cumber) ? $billPaymentInfo->getBillPaymentMultipleClaimNumberInfo->payer_claim_control_cumber : null }}" id="bill_payment_claim_control_number_id" onkeyup="setProcessLevelStep();" data-validation-event="change" data-validation="required"  autocomplete="off"  type="text" name="bill_payment_claim_control_number"   class="form-control" maxlength="10">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <div class="controls">
                                                                    <label class="radio inline">
                                                                        <input {{($billPaymentInfo &&   $billPaymentInfo->bill_close && $billPaymentInfo->bill_close == 1) ? 'checked' : null }} type="radio" onClick="removeDisableFromSpan(this.value);setProcessLevelStep();" name="bill_payment_close_bill" id="bill_payment_close_bill1" value="1"/>
                                                                        YES
                                                                    </label>
                                                                    <label class="radio inline">
                                                                        <input {{($billPaymentInfo &&   $billPaymentInfo->bill_close && $billPaymentInfo->bill_close == 2) ? 'checked' : null }} type="radio" onClick="removeDisableFromSpan(this.value);setProcessLevelStep();" name="bill_payment_close_bill" id="bill_payment_close_bill2" value="2"/>
                                                                        NO
                                                                    </label>
                                                                </div>  
                                                            </div>
                                                        ...
                                                        <fieldset class="pt-2">
                                                            ...
                                                            @if ($billPaymentInfo && $billPaymentInfo->getBillInfo->getBillDocForPayment && $billPaymentInfo->getBillInfo->getBillDocForPayment->injury_document)
                                                                <div class="row">
                                                                    <div class="col-md-12">
