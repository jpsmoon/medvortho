                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            ...
                                            <div class="tab-content" id="nav-tabContent" style="border:0px solid #333">
                                                <div class="tab-pane fade {{ ($tabId == 'multiple') ? 'show active' : ''}}  pr-0 pl-0" id="multiple-bill-payment" role="tabpanel" aria-labelledby="multiple-payment-tab">
                                                    <form  action="{{ url('/update/multiple/bill/payment/post') }}"  enctype="multipart/form-data" id="multipleBillPaymentFrm" class="form-horizontal ladda-form'" method="POST">
                                                        @csrf
                                                        ...
                                                        <input type="text" name="postType" id="postType" value="edit"> 
                                                        ...
                                                        <fieldset  id="">
                                                            ...
                                                            <div class="form-row">   
                                                                <div class="form-group col-md-3">
                                                                    ...
                                                                    <input value="{{($injuryBillInfo && $injuryBillInfo->getPaymentInfo && $injuryBillInfo->getPaymentInfo->getBillPaymentMultipleClaimNumberInfo && $injuryBillInfo->getPaymentInfo->getBillPaymentMultipleClaimNumberInfo->payer_claim_control_cumber) ? $injuryBillInfo->getPaymentInfo->getBillPaymentMultipleClaimNumberInfo->payer_claim_control_cumber : null }}" id="bill_payment_claim_control_number_id" onkeyup="setProcessLevelStep();" data-validation-event="change" data-validation="required"  autocomplete="off"  type="text" name="bill_payment_claim_control_number"   class="form-control" maxlength="10">
                                                                ...
                                                                <div class="col-md-4 control-group">
                                                                    ...
                                                                    <label class="radio inline">
                                                                        <input {{($injuryBillInfo && $injuryBillInfo->getPaymentInfo && $injuryBillInfo->getPaymentInfo->getBillPaymentMultipleClaimNumberInfo && $injuryBillInfo->getPaymentInfo->getBillPaymentMultipleClaimNumberInfo->panality_or_interest_paid && $injuryBillInfo->getPaymentInfo->getBillPaymentMultipleClaimNumberInfo->panality_or_interest_paid == 1) ? 'checked' : null }} onClick="setProcessLevelStep();" type="radio" name="bill_single_payment_panalty_interest_paid" id="bill_single_payment_panalty_interest_paid1" value="1"/>
                                                                        YES
                                                                    </label>
                                                                    <label class="radio inline">
                                                                        <input {{($injuryBillInfo && $injuryBillInfo->getPaymentInfo && $injuryBillInfo->getPaymentInfo->getBillPaymentMultipleClaimNumberInfo && $injuryBillInfo->getPaymentInfo->getBillPaymentMultipleClaimNumberInfo->panality_or_interest_paid && $injuryBillInfo->getPaymentInfo->getBillPaymentMultipleClaimNumberInfo->panality_or_interest_paid == 2) ? 'checked' : null }} onClick="setProcessLevelStep();" type="radio" name="bill_single_payment_panalty_interest_paid" id="bill_single_payment_panalty_interest_paid2" value="2"/>
                                                                        NO
                                                                    </label>
                                                                </div> 
                                                                </div>
                                                                                    ...
                                                                                    <tbody id="tbodyDivId">
                                                                                        ...
                                                                                        @if ($injuryBillInfo) 
                                                                                                @php
                                                                                                    ...
                                                                                                    $pcUnit = $injuryBillInfo->procedure_unit;
                                                                                                    $pcUnitTot += $injuryBillInfo->procedure_unit; 

                                                                                                    if($injuryBillInfo->procedure_charge){
                                                                                                        $pcCharge = $injuryBillInfo->procedure_charge;
                                                                                                    }
                                                                                                     
                                                                                                    if($injuryBillInfo->expected_fee_amt){
                                                                                                        $pcExCharge = $injuryBillInfo->expected_fee_amt;
                                                                                                    }
                                                                                                    else{
                                                                                                        if ($injuryBillInfo->getMasterBillCPDCodeCharge && $injuryBillInfo->getMasterBillCPDCodeCharge->omfs_unit && $injuryBillInfo->getMasterBillCPDCodeCharge->units) {
                                                                                                            $pcExCharge = $injuryBillInfo->getMasterBillCPDCodeCharge->units - $injuryBillInfo->getMasterBillCPDCodeCharge->omfs_unit;
                                                                                                        }
                                                                                                        else{
                                                                                                            $pcExCharge = $injuryBillInfo->master_unit_amount;
                                                                                                        }
                                                                                                    }
                                                                                                    if($injuryBillInfo->calculated_br_amt){
                                                                                                        $pcCalBrCharge = $injuryBillInfo->calculated_br_amt;
                                                                                                    }
                                                                                                    if($injuryBillInfo->original_submission_amt){
                                                                                                        $pcOriginSubCharge = $injuryBillInfo->original_submission_amt;
                                                                                                    }
                                                                                                    if($injuryBillInfo->original_submission_amt){
                                                                                                        $pcBillPaymentCharge = $injuryBillInfo->original_submission_amt;
                                                                                                    }
                                                                                                    if($injuryBillInfo->due_balace_amt){
                                                                                                        $pcDueBalanceCharge = $injuryBillInfo->due_balace_amt;
                                                                                                    }
                                                                                                    if($injuryBillInfo->expected_fee_percent){
                                                                                                        $pcExFeePerCharge = $injuryBillInfo->expected_fee_percent;
                                                                                                    }
                                                                                                ...
                                                                                                @endphp
                                                                                                <tr>
                                                                                                    <td> {{ $injuryBillInfo->procedure_code }}</td>
                                                                                                    ...
                                                                                                    <td>
                                                                                                    <input type="hidden" name="procedure_code_master_id[]" id="bill_procedue_master_id_{{$i}}" value="{{ $injuryBillInfo->master_procedure_code_charge_id}}">
                                                                                                    <input type="hidden" name="bill_service_id[]" id="bill_service_id{{$i}}" value="{{ $injuryBillInfo->id}}">
                                                                                                    <input type="hidden" name="procedure_code[]" id="bill_procedue_code_id_{{$i}}" value="{{$injuryBillInfo->bill_procedure_code}}">
                                                                                                    <input type="hidden" name="procedure_unit[]" id="bill_procedue_unit_id{{$i}}" value="{{ $pcUnit}}">
                                                                                                    <input type="hidden" name="procedure_charge[]" id="pcCharge_input_id_{{$i}}" value="{{ $pcCharge}}">
                                                                                                    <input type="hidden" name="expected_fee_amt[]" id="expected_fee_shedule_input_id_{{$i}}" value="{{ $pcExCharge}}">
                                                                                                    <input type="hidden" name="calculated_br_amt[]" id="calculated_br_reduction_input_id_{{$i}}" value="{{ $pcCalBrCharge}}">
                                                                                                    ...
                                                                                                    name="original_submission_amt[]"  onkeyup="setOriginalPayment(this.value, {{$i}}, {{($injuryBillInfo->procedure_charge && $injuryBillInfo->expected_fee_amt) ? $injuryBillInfo->expected_fee_amt : 0 }}, {{ $pcCharge}})"  data-validation-event="change" data-validation="required, number" maxlength="10">
                                                                                                    <input type="hidden" name="procedure_payment_total[]" id="bill_payment_total_input_id_{{$i}}" value="{{ $pcBillPaymentCharge}}">
                                                                                                    <input type="hidden" name="due_balace_amt[]" id="bill_due_balance_id_{{$i}}" value="{{ $pcDueBalanceCharge}}">
                                                                                                    <input type="hidden" name="expected_fee_percent[]" id="bill_expected_fee_shedule_percent_id_{{$i}}" value="{{ $pcExFeePerCharge}}">
                                                                                                    </td>
                                                        ...
                                                        <div class="row pt-0 pl-0 ml-1 mt-1" style="margin-left:19px!important">
                                                            <div class="col-xs-12 col-sm-12 col-md-12 text-right">
                                                                <button  type="submit" class="btn btn-primary ladda-button"><span class="ladda-label">Update</span></button>
                                                            </div> 
                                                        </div> 
                                                    </form>
                                                </div>
...
function setOriginalPayment(val,index,omfs_unit, procedureChareg){
    ...
    console.log('omfs_unit', omfs_unit);
