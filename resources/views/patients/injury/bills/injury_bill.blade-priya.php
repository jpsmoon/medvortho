    ...
    <input autocomplete="off" type="hidden" id="injuryId" name="injuryId" value="{{$injuryId}}">
        <div class="row  mt-2">
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-row">
                    <div class="form-group col-md-12 input-icons" id="dosDiv">
                        ...
                        data-validation="required date" data-validation-format="mm/dd/yyyy"  data-validation-error-msg="" autocomplete="off" class="form-control" maxlength="100">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <div class="form-check form-check-inline custom-control custom-radio custom-control-inline">
                        <input class="form-check-input"  type="radio"  name="diagnosis_code_type" id="diagnosis_code1" value="9">
                        <label class="form-check-label" for="diagnosis_code1">ICD-9</label>
                    </div>
                    <div class="form-check form-check-inline custom-control custom-radio custom-control-inline">
                        <input class="form-check-input" type="radio" name="diagnosis_code_type" id="diagnosis_code2" value="10">
                ...
                <fieldset id="cloneDivStr">
                               ...
                               <div class="col-xs-12 col-sm-12 col-md-12">
                                ...
                                <div class=" col-md-6">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td colspan="7" class="error_msg" id="showDiagCodeError_{{$kk}}"></td>
                                        </tr>
                                    </table>
                                </div>
                    ...
                    @endif
                        <?php for($i=$cpdCnt; $i <= $service_lineCnt; $i++){?>
                            <div class="row cloneDiv ml-0 mt-1" id="input_{{$i}}">
                                <div class=" col-md-2">
                                        <label for="bill_procedure_code">  Procedure Code   </label>
                                    <input  placeholder="Procedure Code"  data-validation-event="change" data-validation="custom" data-validation-regexp ="^[a-zA-Z0-9]+(\s+[a-zA-Z0-9]+)*$" data-validation-optional="true" data-validation-error-msg="" 
                                ...
                                <div class=" col-md-1 pt-3 cus-plus d-none" id="addition_info_icon_{{$i}}" style="max-width: 2%;">
