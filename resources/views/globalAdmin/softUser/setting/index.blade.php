@extends('layouts.globalAdmin.supar-admin-app')
<style>
   .step {
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-4 ml-4 pl-4 step activeStepInfo" id="step-1">
                                <div class="row step">
                                    <div id="div1" class="col-md-2" onclick="javascript: resetActive(event, 0, 1">
                                        <a class="text-dark" href="{{ url('/view/billing/provider', Auth::user()->id) }}">
                                    ...
                                    <div id="div2" class="col-md-2 otherStep">
                                        <a class="text-dark" href="{{ url('/billing/rendering', Auth::user()->id) }}">
                                    ...
                                    <div id="div3" class="col-md-2 otherStep">
                                        ...
                                        <a class="text-dark" href="{{ url('/places-of-service', Auth::user()->id) }}">
                                    ...
                                    <div id="div4" class="col-md-2 otherStep">
                                        ...
                                        <a class="text-dark" href="{{ url('/billing/provider/cms-1500-form', Auth::user()->id) }}">
                                    ...
                                    <div id="div5" class="col-md-2 otherStep">
                                        ...
                                        <a class="text-dark" href="{{ url('/setting/billing/provider/charge/add', Auth::user()->id) }}">
                                ...
                                <div class="row step">
                                    <div id="div6" class="col-md-2 otherStep">
                                        <span class="fa fa-info-circle fa-larger"></span>
                                        <a class="text-dark" href="{{ url('/billing/providers/recurence', Auth::user()->id) }}">
                                    ...
                                    <div id="div6" class="col-md-2 otherStep">
                                        <span class="fa fa-info-circle fa-larger"></span>
                                        <a class="text-dark" href="{{ url('/billing/providers/reasons', Auth::user()->id) }}">
                                    ...
                                    <div id="div7" class="col-md-2 otherStep">
                                        <span class="fa fa-info-circle fa-larger"></span>
                                        <a class="text-dark" href="{{ url('/billing/providers/holidays', Auth::user()->id) }}">
                            ...
                            <div class="col-12 mt-4 ml-4 pl-4 step hiddenStepInfo" id="step-2">
                                ...
                                <div class="row">
                                    ...
                                    <div id="div1" class="col-md-2">
                                        ...
                                        <a onclick="javascript: resetActive(event, 20, 2);" class="text-dark"
                                            href="{{ url('/billing/provider/task/assignment/preferences', Auth::user()->id) }}">
                                ...
                                <div class="row">
                                    ...
                                    <div id="div1" class="col-md-2">
                                        <a class="text-dark"
                                            href="{{ url('/patients/injury/documents/' . Auth::user()->id . '/Provider') }}">
                                            <span class="fa fa-file-text-o"></span>
                                    ...
                                    <div id="div2" class="col-md-2 otherStep">
                                        <a class="text-dark"
                                            href="{{ url('/provider-bill-write-off-reason/' . Auth::user()->id . '/1') }}">
                                            <span class="fa fa-file-text-o"></span>
                                    ...
                                    <div id="div3" class="col-md-2 otherStep">
                                        <span class="fa fa-file-text-o"></span>
                                        <a class="text-dark"
                                            href="{{ url('/provider-bill-write-off-reason/' . Auth::user()->id . '/2') }}">
                                    ...
                                    <div id="div3" class="col-md-2 otherStep">
                                        <span class="fa fa-file-text-o"></span>
                                        <a class="text-dark"
                                            href="{{ url('/provider-bill-write-off-reason/' . Auth::user()->id . '/3') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div id="div1" class="col-md-2" onclick="javascript: resetActive(event, 0, 1);">
                                        <span class="fa fa-file-text-o"></span>
                                        <a class="text-dark" href="{{ url('/add-custom-billing-template', Auth::user()->id) }}">
                                    ...
                                    <div id="div2" class="col-md-2 otherStep">
                                        ...
                                        <a class="text-dark"
                                            href="{{ url('/list-of-custom-referring-ordering-providers', Auth::user()->id) }}">
                                            <span class="fa fa-user-md"></span>
                                    ...
                                    <div id="div3" class="col-md-2 otherStep">
                                        <span class="fa fa-usd"></span>
                                        <a class="text-dark"
                                            href="{{ url('/settings/providers/expected/reimbursements/' . Auth::user()->id . '/2') }}">
                            ...
                            <div class="col-12 mt-4 ml-4 pl-4 step hiddenStepInfo" id="step-3">
                                ...
                                <div class="row">
                                    ...
                                    <div id="div2" class="col-md-2 otherStep">
                                        <a class="text-dark" href="{{ url('/list/rfa/requesting/physicians', Auth::user()->id) }}">
                                            <span class="fa fa-user-md"></span>
                                    ...
                                    <div id="div3" class="col-md-2 otherStep">
                                        <span class="fa fa-map-marker"></span>
                                        <a class="text-dark" href="{{ url('/list/rfa/practice/locations', Auth::user()->id) }}">
                                    ...
                                    <div id="div3" class="col-md-2 otherStep">
                                        ...
                                        <a class="text-dark" href="{{ url('/list/practice/contact', Auth::user()->id) }}">
                                ...
                                <div class="row">
                                    ...
                                    <div id="div2" class="col-md-2 otherStep">
                                        <a class="text-dark" href="{{ url('/add/rfa/template', Auth::user()->id) }}">
                                            <span class="fa fa-file-text-o"></span>
                            ...
                            <!--        <div id="div1" class="col-md-2" onclick="javascript: resetActive(event, 0, 1);">-->
                            <!--            <a class="text-dark"-->
                            <!--                href="{{ url('/bill-submissions/letters/sbr-letter', Auth::user()->id) }}">-->
                            ...
                            <!--        <div id="div2" class="col-md-2 otherStep">-->
                            <!--            <a class="text-dark"-->
                            <!--                href="{{ url('/bill-submissions/letters/rfa-letter', Auth::user()->id) }}">-->
                            <!--                <span class="fa fa-regular fa-file-lines"></span>-->
                            ...
                            <!--            <span class="fa fa-regular fa-file-lines"></span>-->
                            <!--            <a class="text-dark"-->
                            <!--                href="{{ url('/bill-submissions/letters/pr2-letter', Auth::user()->id) }}">-->
                            ...
                            <!--            <span class="fa fa-regular fa-file-lines"></span>-->
                            <!--            <a class="text-dark"-->
                            <!--                href="{{ url('/bill-submissions/letters/resubmission-letter', Auth::user()->id) }}">-->
                            ...
                            <!--            <span class="fa fa-regular fa-file-lines"></span>-->
                            <!--            <a class="text-dark"-->
                            <!--                href="{{ url('/bill-submissions/letters/demand-letter', Auth::user()->id) }}">-->
                            ...
                            <!--            <span class="fa fa-regular fa-file-lines"></span>-->
                            <!--            <a class="text-dark"-->
                            <!--                href="{{ url('/bill-submissions/letters/authorization-letter', Auth::user()->id) }}">-->
