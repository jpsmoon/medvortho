...
class StateSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('states')->insert([
            ...
            [
                'country_id' => 2,
                'state_name' => 'Howland Island UM-84',
                'is_active' => 1,
            ],
            [
                'country_id' => 2,
            ...
            [
                'country_id' => 2,
                'state_name' => 'Jarvis Island UM-86',
                'is_active' => 1,
            ],
            [
                'country_id' => 2,
                'state_name' => 'Johnston Atoll UM-67',
                'is_active' => 1,
            ],
            [
                'country_id' => 2,
            ...
            [
                'country_id' => 2,
                'state_name' => 'Navassa Island UM-76',
                'is_active' => 1,
            ],
            [
                'country_id' => 2,
            ...
            [
                'country_id' => 2,
                'state_name' => 'Palmyra Atoll UM-95',
                'is_active' => 1,
            ],
            [
                'country_id' => 2,
            ...
            [
                'country_id' => 2,
                'state_name' => 'United States Minor Outlying Islands UM',
                'is_active' => 1,
            ],
            [
                'country_id' => 2,
                'state_name' => 'United States Virgin Islands VI',
                'is_active' => 1,
            ],
            [
                'country_id' => 2,
